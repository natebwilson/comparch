module read_data (
  ...
  always @(*) begin
    ...
    //load formatting
    case (LoadType)
      3'b000: DataOut = ReadData;
      3'b001: DataOut = {24'b0, selected_byte};
      3'b010: DataOut = {{24{selected_byte[7]}}, selected_byte};
      3'b100: DataOut = {16'b0, selected_half};
      3'b101: DataOut = {{16{selected_half[15]}}, selected_half};
